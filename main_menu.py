...
class SettingsMenu:
    def __init__(self):
        ...
        self.buttons = [
            Button("Easy", position=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 - 60)),
            Button("Normal", position=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2)),
            Button("Hard", position=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 60)),
            Button("Back", position=(SCREEN_WIDTH // 2, SCREEN_HEIGHT // 2 + 120), font_size=36)
        ]
            ...
            for button in self.buttons:
                if button.rect.collidepoint(mouse_pos):
                    if button.text == "Easy":
                        ...
                        set_spawn_interval(5)
                    elif button.text == "Normal":
                        from settings import set_spawn_interval
                        set_spawn_interval(3)
                    elif button.text == "Hard":
                        from settings import set_spawn_interval
                        set_spawn_interval(1.5)
